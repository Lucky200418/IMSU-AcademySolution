...
function SaveGpa(){
    ...
    if(!(studentData.gpaArray.length > 0)) {
        ...
        if(firstSemester){
            curLevelData.firstSemester.results.splice(0, curLevelData.firstSemester.results.length)
         ...
         if(secondSemester){
            curLevelData.secondSemester.results.splice(0, curLevelData.secondSemester.results.length)
             curLevelData.secondSemester.results.push(studentData.gpaArray)
             curLevelData.secondSemester.gpa.splice(0, curLevelData.secondSemester.gpa.length)
